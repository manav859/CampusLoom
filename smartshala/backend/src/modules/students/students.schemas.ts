...
export const studentSchema = z.object({
  ...
  aadhaar: z.string().trim().min(1).nullable().optional(),
  apaar: z.string().trim().min(1).nullable().optional(),
  previousSchool: z.string().trim().min(1).nullable().optional(),
  siblingDiscount: z.coerce.boolean().optional(),
