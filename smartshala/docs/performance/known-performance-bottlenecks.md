...
| 3 | **Neon cold starts** - first request after idle can be slow or fail once | Mitigated with retry wrappers; DB warmup is opt-in because scheduled pings increase compute usage |
