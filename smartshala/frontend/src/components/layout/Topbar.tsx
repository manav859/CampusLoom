        ...
        <div className="flex w-full items-center justify-between gap-2 px-3 sm:gap-4 sm:px-5">
          ...
          <div className="flex min-w-0 flex-1 items-center">
            ...
            <div className="flex w-auto md:w-[220px] shrink-0 items-center gap-3">
              ...
              {/* PC View Brand Logo */}
              <div className="hidden md:flex h-10 w-10 shrink-0 items-center justify-center rounded-lg overflow-hidden">
                <img alt="SmartShala" className="h-full w-full object-contain mix-blend-multiply rounded-lg" src="/logo-latest.png" />
              </div>
            </div>
            ...
            <div className="relative" ref={menuRef}>
              ...
              {menuOpen && (
                <div className="absolute right-0 top-[calc(100%+8px)] z-[110] w-56 rounded-2xl bg-white/95 backdrop-blur-xl border border-[rgba(0,0,0,0.06)] shadow-[0_8px_32px_rgba(0,0,0,0.12)] py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <div className="py-1">
                    <Link 
                      href={withSchoolPath("/profile", pathname)}
                      className="w-full flex items-center gap-3 px-4 py-2.5 text-[13px] font-medium text-[#1d1d1f] hover:bg-[#f5f5f7] transition-colors text-left"
                    >
