    ...
    <div className="dashboard-panel-card relative flex h-[360px] flex-col p-4 sm:p-5">
      <div className="mb-3 flex shrink-0 items-start justify-between gap-3">
        ...
        {selectedDate && onDateChange ? (
          <label className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-[#DCE1E8] bg-white text-[#2456E6] transition hover:bg-[#F2F7FC]">
