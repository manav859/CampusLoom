        ...
        >
          <div>
            <Link href="/login" className="inline-flex items-center gap-2.5">
              <span className="flex h-14 w-14 items-center justify-center rounded-xl overflow-hidden shadow-lg shadow-[#2456E6]/30">
                <img alt="SmartShala" className="h-full w-full object-contain rounded-xl" src="/logo-latest.png" />
              </span>
            </Link>
